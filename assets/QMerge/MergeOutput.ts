import { Component, _decorator, Node, tween, LabelComponent, Color, color, Vec3, v3 } from "cc";
...
export default class MergeOutput extends Component {
    ...
    private showOutput() {
        ...
        tween(node).to(this.output_anim_dur, { position: v3(0, this.output_anim_dist, 0) }, { easing: "sineInOut" }).start()
        //播放后，清0 
        this._output_val = 0
    }
