import { Component, _decorator, Node, Vec3, v3, Quat, quat, randomRange, randomRangeInt } from "cc";
import { Car } from "./Car";
...
export default class AICar extends Car {
    ...
    onEnter_Crash() {
        ...
        Quat.fromEuler(this._crash_rotate, randomRangeInt(0, 20), randomRange(0, 20), randomRange(0, 20))
    }
