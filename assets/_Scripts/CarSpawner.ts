import { Component, _decorator, CCClass, Node, macro, misc, randomRange, math, Quat, quat, Vec2, Vec3, v3, v2, instantiate, Prefab, randomRangeInt, CameraComponent } from "cc";
