...
export class MergeHome extends Component {
  ...
  showSdk() {
    ...
    let interfull_sc: Node = window['zzsdkuiNew'].interFull_scroll(
      0,
      'inter_full',
      null,
      0,
    ...
    //猜你喜欢
    this.youlike = window['zzsdkuiNew'].youlike(
      0,
      null,
      null,
      '1',
    ...
    //float1
    let float1 = window['zzsdkuiNew'].float(
      0,
      -250,
      0,
      'float1',
    ...
    let float2 = window['zzsdkuiNew'].float(
      1,
      250,
      0,
      'float2',
