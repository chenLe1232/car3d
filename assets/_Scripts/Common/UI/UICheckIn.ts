import { _decorator, Node, ButtonComponent, LabelComponent, SpriteComponent, Component, ToggleComponent } from "cc";
...
export default class UICheckIn extends UIBase {
    ...
    onLoad() {
        ...
        csv.CheckIn.values.forEach((v, i) => {
            this.daysData.push({ type: v.reward, day: i + 1, imageUrl: null, num: v.number } as CheckInDayData)
        })
