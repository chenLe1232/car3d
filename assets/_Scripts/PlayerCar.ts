import { Car } from "./Car";
import { instantiate, Node, ColliderComponent, ParticleSystemComponent, Quat, quat, Vec3, v2, Vec2, director, math, v3, setDefaultLogTimes, randomRangeInt, _decorator } from "cc";
...
export default class PlayerCar extends Car implements FizzCollideInterface {
    ...
    onUpdate_Start() {
        if (this.fsm.timeElapsed > 2 || this.moveEngine.velocity.z >= this.normal_maxSpeed) {
