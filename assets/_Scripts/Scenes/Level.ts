import { Component, _decorator, Node, Vec3, v3, systemEvent, SystemEventType, System, director, easing, math, misc, ModelComponent, loader, Texture2D, CameraComponent, ParticleSystemComponent, tween, randomRangeInt, game, resources, assetManager } from "cc";
...
export default class Level extends Component {
    ...
    setBackground(bgName) {
        ...
        resources.load("Texture/sky/" + bgName + '/texture', Texture2D, (err, res) => {
    ...
    static mapNames = ['skybox01', 'skybox02', 'skybox03', 'skybox04', 'skybox05']
    ...
    onEnter_Win() {
        ...
        tween(this.mainCamera).to(1.0, { followScalar: 0 }, { easing: "sineOut" }).start()
        this.removeBuffs()
