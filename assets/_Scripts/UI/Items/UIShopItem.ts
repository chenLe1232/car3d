import { Component, _decorator, Node, SpriteComponent, LabelComponent, ButtonComponent, Color } from "cc";
...
import { mergeSystem, ResultCode } from "../../Common/MergeFramework/MergeSystem";
...
export default class UIShopItem extends mvc_View {
    ...
    onLoad() {
        ...
        this.register<InfoCar>(this.label_cost, _ => _.canBuy ? _.currentPrice.toUnitString() : "-");
