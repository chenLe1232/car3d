import { Component, _decorator, Node, LabelComponent, ButtonComponent } from "cc";
...
export default class UICoinSpeed extends UIBase {
    ...
    onLoad() {
        super.onLoad()
        this.register(this.label_speed0, () => mergeSystem.get_total_outputSpeed().toUnitString() + '/秒');
        this.register(this.label_speed1, () => (mergeSystem.get_total_outputSpeed() * 2).toUnitString() + '/秒');
