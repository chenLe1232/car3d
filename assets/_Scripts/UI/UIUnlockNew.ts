import { Component, _decorator, Node, ModelComponent, UIModelComponent, LabelComponent } from "cc";
...
export default class UIUnlockNew extends UIBase {
    ...
    onLoad() {
        ...
        this.register(this.label_gold, () => this.d.unlock_rewards[0].count.toUnitString());
    ...
    getReward(mult = 1) {
        ...
        this.d.unlock_rewards.forEach(v => {
            if (v.type == ResType.Coin)
                MergeStorage.gold += v.count * mult
