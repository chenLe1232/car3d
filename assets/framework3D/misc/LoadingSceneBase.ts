...
import { _decorator, Component, Node, Prefab, LabelComponent, ProgressBarComponent, director, loader, instantiate, find, isValid, resources } from "cc";
...
export default class LoadingSceneBase extends Component {
    ...
    @property(LabelComponent)
    private percentLabel!: LabelComponent ;
    ...
    loadNextScene(prefabTobeLoad?) {
        ...
        return new Promise((resolve, reject) => {
            director.preloadScene(targetScene, (c, t, i) => {
                ...
                if (prefabTobeLoad) {
                    resources.load(prefabTobeLoad, Prefab, (err, prefab: Prefab) => {
