...
import { _decorator, Component, Node, AudioClip, Prefab, loader, instantiate, find, WidgetComponent, UIRenderComponent, UIReorderComponent, SpriteComponent, color, TERRAIN_HEIGHT_BASE, UITransformComponent, resources } from "cc";
