...
declare namespace csv{
    ...
    export class CarAttr{
        ...
        static search(predicate: (value: CarAttr_Row, index: number) => boolean):CarAttr_Row[]
        static size:number;
    }
    ...
    export class CarInfo{
        ...
        static search(predicate: (value: CarInfo_Row, index: number) => boolean):CarInfo_Row[]
        static size:number;
    }
    ...
    export class CheckIn{
        ...
        static search(predicate: (value: CheckIn_Row, index: number) => boolean):CheckIn_Row[]
        static size:number;
    }
    ...
    export class Supply{
        ...
        static search(predicate: (value: Supply_Row, index: number) => boolean):Supply_Row[]
        static size:number;
    }
